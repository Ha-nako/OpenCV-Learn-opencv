...
/** Global variables */
String face_cascade_name = "D:/pp/eye_trace/haarcascade_frontalface_default.xml";
String eyes_cascade_name = "D:/pp/eye_trace/haarcascade_eye.xml";
...
int main(void)
{
    Mat frame = imread("D:/pp/test.png");
